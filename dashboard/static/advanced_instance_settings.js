...
// Preset auto-submit when selecting an option
...
if (init_dirs_element && init_dirs_element.value != "") {
...
if (init_labels_element && init_labels_element.value != "") {
...
if (init_volumes_element && init_volumes_element.value != "") {
...
if (init_env_element && init_env_element.value != "") {
