...
urlpatterns = [
    ...
    path("pause_instance/<app_name>/", views.pause_instance, name="pause_instance"),
    path("pause_instance/<app_name>/<should_kill>", views.pause_instance, name="pause_instance"),
    path("start_instance/<app_name>/", views.start_instance, name="start_instance"),
    path("recreate_instance/<app_name>/", views.recreate_instance, name="recreate_instance"),
    ...
    path("remove_preset/<preset_pk>/", views.remove_preset, name="remove_preset"),
